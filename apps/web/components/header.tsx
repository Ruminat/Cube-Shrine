        ...
        <div className="flex min-w-0 flex-1 items-center gap-4 md:gap-6">
          ...
          >
            ...
            <div className="min-w-0 text-left">
              ...
              <p className="truncate text-xs text-muted-foreground">CFOP algorithm gallery</p>
            </div>
          </Link>
          ...
          <nav className="hidden flex-wrap items-center gap-1 md:flex" aria-label="Main">
            <Link
              ...
              className={cn(
                ...
                !isTimerRoute ? "bg-muted text-foreground" : "text-muted-foreground hover:bg-muted/60 hover:text-foreground"
              )}
            >
              Algorithms
            </Link>
