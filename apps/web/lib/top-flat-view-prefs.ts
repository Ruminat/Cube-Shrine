 ...
 */
export const ollTopFlatViewEnabled$ = persistentBoolean("cube-shrine:oll-top-flat-view", false);

/**
 * PLL list + cards: top-down U-layer diagram with permutation arrows. Separate from OLL so each category
 * can be toggled independently.
 */
export const pllTopFlatViewEnabled$ = persistentBoolean("cube-shrine:pll-top-flat-view", false);
